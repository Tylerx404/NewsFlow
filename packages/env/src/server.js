...
export const env = createEnv({
    ...
    runtimeEnv: {
        ...
        STRIPE_PRICE_BASIC_MONTHLY: process.env.STRIPE_PRICE_BASIC_MONTHLY ?? process.env.STRIPE_PRICE_BASIC,
        STRIPE_PRICE_PRO_MONTHLY: process.env.STRIPE_PRICE_PRO_MONTHLY ?? process.env.STRIPE_PRICE_PRO,
        STRIPE_PRICE_MAX_MONTHLY: process.env.STRIPE_PRICE_MAX_MONTHLY ?? process.env.STRIPE_PRICE_MAX,
    },
