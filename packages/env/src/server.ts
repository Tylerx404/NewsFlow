...
export const env = createEnv({
  server: {
    ...
    STRIPE_PRICE_BASIC: z.string().startsWith("price_", "Invalid Stripe price id format"),
    STRIPE_PRICE_PRO: z.string().startsWith("price_", "Invalid Stripe price id format"),
    STRIPE_PRICE_MAX: z.string().startsWith("price_", "Invalid Stripe price id format"),
